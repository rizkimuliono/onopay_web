...
<div class="content">
    <!-- Header -->
    <div class="mb-4">
        <h1 class="h3 mb-1" style="color: #003d7a; font-weight: 600;">Tambah User Baru</h1>
        <p style="color: #666; margin: 0;">Silakan isi form di bawah untuk menambah user baru</p>
    </div>
